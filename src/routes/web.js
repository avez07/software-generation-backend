...
router.route('/AddSoftware').post(upload.fields([{name:'image'}]),DynamicController.AddSoftware)
router.route('/UpdateSoftware').post(upload.fields([{name:'image'}]),DynamicController.UpdateSoftware)
