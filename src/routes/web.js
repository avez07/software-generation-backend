...
router.route('/AddSoftware').post(upload.fields([{name:'image'},{name:'specification'}]),DynamicController.AddSoftware)
router.route('/UpdateSoftware').post(upload.fields([{name:'image'},{name:'specification'}]),DynamicController.UpdateSoftware)
